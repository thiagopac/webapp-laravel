...
class BootstrapDemo2 extends BootstrapBase {
    ...
    private static function initPage() {
        Theme::addHtmlAttribute('body', 'style', 'background-image: url(' . Theme::appearance('header-background') . ')');
    }
    ...
    public static function getBreadcrumb($options = array('skip-active' => false)) {
