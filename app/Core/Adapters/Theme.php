...
class Theme extends \App\Core\Theme
{
     ...
     * @param  string  $demo
     */
    public static function setDemo($demo = 'demo2')
    {
        Theme::$demo = $demo;
    }
    ...
    public static function appearance($asset) {

        $value = match ($asset) {
            'header-background' => asset('appearance/header-bg.png'),
            'logo' => asset('appearance/logo-1-default.svg'),
            'logo-white' => asset('appearance/logo-1-white.svg'),
            default => '',
        };
