    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('date', function (Collection $model) {
                return $model->get('date')->format('m/d/Y H:i:s');
            })
            ...
            ->editColumn('context', function (Collection $model) {
                ...
                return view('pages.manage.system._details', compact('content'));
            })
            ;
    }
...
//                "buttons" => ['print'],
    ...
    {
        return [
            Column::make('id')->title('Log ID')->addClass('text-center'),
            Column::make('message')->title('Mensagem'),
            Column::make('level')->title('Tipo'),
            Column::make('date')->title('Data')->width(130),
            Column::make('environment')->title('Ambiente')->addClass('none'),
            Column::make('file_path')->title(__('Arquivo log'))->addClass('none'),
