...
<div class="card card-dashed {{ $class }}">
    ...
    <div class="card-body d-flex justify-content-between text-center flex-column">
        ...
        <div class="d-flex flex-column mt-4 mb-14">
            ...
            <!--begin::Number-->
            <span class="fw-bold fs-3x text-gray-800 lh-1">{{ $balanceCrypto }} <span class="fs-3 text-gray-500">DEC</span></span>
            <!--end::Number-->

            <!--begin::Description-->
            <span class="fw-bold fs-6 text-gray-400 mt-5">{{ __('Disponível para venda ou abatimentos da conta de luz') }}</span>
            <!--end::Description-->
        ...
        <!--begin::Action-->
        <div class="m-0">
            <a href="{{ route('negotiate.purchase') }}" class="btn btn-bg-primary btn-color-white w-100 fs-6 px-8 py-4 mt-2 text-uppercase">{{ __('Comercializar') }}</a>
        </div>
        <!--end::Action-->
