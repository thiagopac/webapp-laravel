...
{{--                <img alt="Logo" src="{{ asset(theme()->getMediaUrlPath() . 'logos/logo-1-white.svg') }}" class="logo-default h-25px"/>--}}
{{--                <img alt="Logo" src="{{ asset(theme()->getMediaUrlPath() . 'logos/logo-1-blue.svg') }}" class="logo-default h-25px"/>--}}
                <img alt="Logo" src="{{ theme()->appearance('logo-white') }}" class="logo-default h-25px"/>
            </a>
        </div>
        <!--end::Header Logo-->
